...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Dodaj użytkownika</h1>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                <button type="button" class="btn btn-block btn-primary" onclick="$('#user_store_form').submit();">Zapisz</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div id="wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <form action="{{ route('user.store') }}" method="POST" id="user_store_form">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('login') is-invalid @enderror" id="login" placeholder="Wpisz login" name="login" value="{{ old('login') }}">
                                            @error('login')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Wpisz email" name="email" value="{{ old('email') }}">
                                            @error('email')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="admin" name="admin">
                                                <option value="0" @if (old('admin')==0 || empty(old('admin'))) selected @endif>Użytkownik</option>
                                                <option value="1" @if (old('admin')==1) selected @endif>Administrator</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
